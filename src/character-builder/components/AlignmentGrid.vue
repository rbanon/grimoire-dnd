  ...
  <div class="grid grid-cols-3 gap-1.5" role="radiogroup" aria-label="Alignment">
    <div
      ...
      :class="modelValue === a.value
        ? 'border-gold-mid bg-gold-dim/20 text-gold-deep shadow-[0_0_0_1px_rgba(212,168,67,0.15)]'
        : 'border-shadow bg-depths text-mist hover:border-gold-mid/40 hover:text-stone hover:bg-shadow/40'"
      role="radio"
