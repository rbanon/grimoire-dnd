  ...
  <Teleport to="body">
    <Transition name="loh-fade">
      ...
      >
        ...
        <div class="relative w-full max-w-md bg-void border border-shadow rounded-lg shadow-2xl flex flex-col">
          <div class="h-0.5 w-full bg-gold-mid shrink-0" />

          <!-- Header -->
          <div class="px-5 pt-4 pb-3">
            <div class="flex items-center justify-between">
              <p class="font-heading text-base text-gold-mid tracking-wide">Lay on Hands</p>
