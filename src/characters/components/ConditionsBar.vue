...
const CONDITION_LIST = [
  ...
  { name: 'Frightened',    activeClass: 'bg-gold-dim/30 text-gold-bright border-gold-dim/50' },
  { name: 'Grappled',      activeClass: 'bg-gold-deep/20 text-gold-mid border-gold-deep/40' },
  ...
  { name: 'Restrained',    activeClass: 'bg-gold-dim/20 text-gold-mid border-gold-dim/40' },
